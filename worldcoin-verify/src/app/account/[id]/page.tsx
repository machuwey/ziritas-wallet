...
interface ProfileTestPageProps {
  ...
  export default function UniqueWalletVerificationPage({ params }: ProfileTestPageProps) {
    const { id: walletAddress } = params;

    console.log("Unique ID: ", walletAddress);
	...
	return (
		<div>
			<div className="flex flex-col items-center justify-center align-middle h-screen">
				<p className="text-2xl mb-5">Verify Uniqness of Wallet</p>
				<IDKitWidget
					action={process.env.NEXT_PUBLIC_WLD_ACTION!}
